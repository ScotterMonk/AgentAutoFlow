---
name: app-standards
description: All modes that write scripts or code follow these app standards for communication, modularization, creation, editing, naming conventions, refactoring.
---
...
## Modularization
**Scope**: Critical all logic files, including Python, JS, etc.
