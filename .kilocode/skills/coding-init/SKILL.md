---
name: coding-init
description: When a coding or scripting mode needs to initiate coding execution. The modes include "coder-sr", "coder-jr". Use this skill to set up context, understand the task, locate any existing plan, and establish the testing type before beginning work.
---
