---
name: coding-finish
description: When a coding or scripting mode ("code", "coder-sr", "coder-jr") has finished its primary task(s) and it is time for cleanup.
---
...
3) **Test your changes**:
- *Choose the most appropriate testing type to use.*
- *If you choose to write tests*: First check the `{base folder}/tests` folder for the same or similar existing tests to emulate or use, depending on how similar.
