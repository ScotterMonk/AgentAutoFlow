...
- `log file`: `.kilocode/docs/reports/log_{date-time}_{short name}.md`.
...
- `report file`: `.kilocode/docs/reports/rep_{date-time}_{short name}.md`
...
- **Resource sites**: General `Resource sites`: `.kilocode/skills/research/resources/sites-general.md`.
- **Source of truth for conflicts of interest and impact**: Read the `.kilocode/skills/research/resources/coi-` files relevant to the current type of research.
...
If you find yourself in a grey area situation where you are undecided whether to utilize consensus or require a deeper understanding of reasons not to use consensus, read `.kilocode/skills/research/resources/consensus.md`.
...
- **General health-related**: Use `.kilocode/skills/research/resources/sites-health-and-nutrition.md`.
- **Nutrition and biohacking**: Use `.kilocode/skills/research/resources/sites-health-and-nutrition.md`.
- **COVID-19 and vaccination**: Use `.kilocode/skills/research/resources/sites-health-and-nutrition.md`.

**Source of truth for conflicts of interest and impact**:
- Use `.kilocode/skills/research/resources/coi-health-and-nutrition.md`.
...
**Resource sites**:
Read the files relevant to the current type of research:
- **General energy-related**: Use `.kilocode/skills/research/resources/sites-energy.md`.
- **Oil**: Use `.kilocode/skills/research/resources/sites-energy-oil.md`.
- **Nuclear**: Use `.kilocode/skills/research/resources/sites-energy-nuclear.md`.
